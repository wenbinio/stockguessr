# StockGuessr weekly Execution Desk — week 11 brief (poll date 2026-09-26)
...
**Next trading date is Monday 2026-09-28.** Any leg you register enters at the
2026-09-28 close.

Your week-10 book filled at the 2026-09-21 close and your packet shows how it has
marked since. Five standing orders fired that day, four of them stops on short legs
caught by a 1.55% rally in SPY. Your decision this week enters at the 2026-09-28
close.
...
automatic — today is 2026-09-26, so anything you can find is fair game. **Do the
...
{"name": "<exact name from your packet>",
 ...
 "entry": "2026-09-28", "capital_usd": 1000,
 "cash_pct": 10,
...
8. **Every symbol must be a real, currently-listed instrument.** The desk resolves
   each one against the price source before accepting your book, and a book naming a
   ticker that does not exist is refused whole. Last week a book was rejected for
   allocating 8% to `IUSX`, described in its own thesis as the "iShares MSCI USA
   Dividend ETF" — no such listing exists. If you want a fund, check the ticker; do
   not infer one from a fund's name.
